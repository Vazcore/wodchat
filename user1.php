<?php
	...
	//$token = "0256ab22b4fd25d78f205f5d83023cd83cd9a597";
	//$token = "9f5feb26f991be77205ccab3e78a5b28d1a2e498";
	$token = "c62de1f39358e4896f297eeea85586316532567b";	
	//$token = "9d8ea0c7c82a0932b8112efbb2ab4e9a1acbb5c4";	
	$token = "22d14abffd77067d7f18e2e3297c5dcc4d1a30fe";
	
	//"9f5feb26f991be77205ccab3e78a5b28d1a2e498";//"0256ab22b4fd25d78f205f5d83023cd83cd9a597";//"f87de2a3e49ad2fa7aac0be148c9a37c9de22b6b";
	$invite_ids = "5,6";
?>
<!DOCTYPE html>
<html>
...
<div class="container">	
	<div class="panel panel-info" id="panelGeneral">
		...
		<button class="btn btn-success" id="join_room">Change room</button><br>
...
<script type="text/javascript">
	(function() {
		...
		$("#inv").click(function() {			
			socket.emit('invite_to_chat', {uid:8454});
		...
		$("#join_room").click(function(){
			$(document).trigger("join_room", [socket]);
		});
		...
		$(document).on("success_login", function() {
			//socket.emit('join_room', {room:"12765->12764->12745->12744->12712"});					
			socket.emit('join_room', {room:"12765->12745->12744->12712"});					
		});
		...
		$("#send").click(function() {
			...
			socket.emit('send_message', {room:"12765->12745->12744->12712", msg:msg, cacheKey: hashCode(makeid()+makeid())});			
		});
